...
const DEFAULT_OPENCLAW_CONFIG_PATH = process.env.OPENCLAW_CONFIG_PATH || path.join(process.env.HOME || "", ".openclaw", "openclaw.json");
const OPENCLAW_STATE_DIR = process.env.OPENCLAW_STATE_DIR || path.join(process.env.HOME || "", ".openclaw");
